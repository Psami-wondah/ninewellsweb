export const company = {
  ...
  about: [
    'Beyond commercial awareness, industry knowledge and legal insight, we take the time to understand each client’s business, competitive environment, regulatory obligations and risk appetite, so we can effectively advance their interests. Our interconnected practice areas allow us to handle complex, multidimensional mandates within a single law firm.',
    'Nigeria’s legal and commercial landscape is dynamic, competitive and increasingly shaped by global forces reshaping industries and markets. In response, we have built a strong, highly qualified team of experienced lawyers and business-support executives drawn from leading law firms in Nigeria. Our lawyers belong to no fewer than 15 local and international professional bodies relevant to their areas of practice, and prioritise continuous professional development alongside the certifications required to practise in their specialised fields.',
    'With an extensive legal library combined with cutting-edge technology, Ninewells upholds the highest standards of professional values, regulatory compliance and service excellence. The firm is duly certified by the Financial Reporting Council of Nigeria (FRC), the Special Control Unit against Money Laundering (SCUML), the Nigeria Data Protection Commission (NDPC), the Nigeria Social Insurance Trust Fund (NSITF) and the International Organization for Standardization (ISO), and maintains Professional Indemnity Insurance.',
  ],
  ...
  contact: {
    ...
    chiefOperationsOfficer: '08056527337',
  },
  social: {
  ...
  offices: [
    {
      ...
      mapUrl: 'https://maps.google.com/?q=Construction+House+(Second+Floor),+18+Adeyemo+Alakija+Street,+Victoria+Island,+Lagos',
    },
    {
      city: 'Abuja',
      area: 'Maitama',
      ...
      mapUrl: 'https://maps.google.com/?q=16+Aso+Gardens+Estate,+River+Trent+Street,+Off+Thames+Street,+Ministers+Hills,+Maitama,+Abuja',
    },
  ],
} as const
