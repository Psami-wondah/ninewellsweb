...
export const people: Person[] = [
  ...
  },
  {
    ...
    imagePosition: 'center 18%',
    expertise: [],
    bio: 'Adebimpe’s academic background, professional training and experience give her the skill set to keep Ninewells organised so its lawyers can deliver immediate legal solutions to clients, applying cutting-edge technology, the best available legal resources and a cost-effective approach.',
    background: [
      'She supports the firm’s day-to-day operations and coordinates its people, systems and legal resources for effective client service.',
