...
export function ThemeToggle({
  ...
  return (
    <button
      className="group inline-flex min-h-11 items-center gap-3 border-0 bg-transparent text-[13px] font-medium text-navy transition-colors hover:text-teal-dark dark:text-paper dark:hover:text-teal"
      type="button"
      onClick={onToggle}
