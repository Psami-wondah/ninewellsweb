...
export function PeopleSection() {
  return (
    <section className="bg-paper px-[clamp(22px,7vw,118px)] py-[clamp(76px,9vw,120px)] dark:bg-[#071224]" id="people" aria-labelledby="people-heading">
      <div className="grid items-end gap-6 lg:grid-cols-[1.2fr_.65fr_auto] lg:gap-12">
      ...
      <div className="mt-16 grid overflow-hidden border-y border-navy/20 bg-ivory dark:border-white/20 dark:bg-[#0a192c] lg:grid-cols-[.78fr_1.22fr]">
