  ...
  return (
    <section className="relative overflow-hidden bg-navy-deep px-[clamp(22px,8vw,135px)] py-[clamp(82px,9vw,120px)] text-ivory dark:bg-[#020914]" id="contact" aria-labelledby="contact-heading">
      ...
      <div data-reveal="up">
        ...
        <a className="group inline-flex items-center gap-6 border-b border-teal-light pb-2 text-[15px] font-semibold text-ivory no-underline" href="/contact">Contact Ninewells <ArrowRight className="text-teal-light transition-transform group-hover:translate-x-1" size={22} /></a>
      </div>
    </section>
  )
}
