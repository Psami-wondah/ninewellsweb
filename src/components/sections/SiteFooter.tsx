...
export function SiteFooter() {
  return (
    <footer className="grid gap-12 bg-ivory px-[clamp(22px,7vw,118px)] pt-16 pb-7 dark:bg-[#071224] sm:grid-cols-2 lg:grid-cols-[1.15fr_.55fr_1.15fr] lg:gap-16">
      ...
      <div className="flex flex-col gap-3 text-[12px]"><p className="mb-1 text-[10px] font-semibold uppercase tracking-[.12em] text-teal-dark dark:text-teal-light">Explore</p><Link className="no-underline" to="/about">About</Link><Link className="no-underline" to="/#expertise">Expertise</Link><Link className="no-underline" to="/#industries">Industries</Link><Link className="no-underline" to="/people">People</Link><Link className="no-underline" to="/#insights">Insights</Link><Link className="no-underline" to="/contact">Contact</Link></div>
